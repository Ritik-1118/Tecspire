    ...
    <nav className='w-full z-50 p-4 shadow-sm shadow-slate-500 fixed  font-medium text-white glass_effect'>
      <div className='container mx-auto flex justify-between items-center'>
        ...
        <div className='hidden md:flex gap-8 items-center'>
          <Link href='/blog' className='hover:text-green-750 flex items-center'>Home</Link>
      ...
      <div
        className={`fixed top-0 right-0 h-[100vh] glass_effect text-white w-64 transform transition-transform duration-700 ease-in-out ${
      ...
      >
        ...
        <Link href='/blog' className='hover:text-green-750 justify-center  w-full items-center text-center' onClick={toggleMenu}>Home</Link>
